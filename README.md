...
│   ├── data_agg.py              # Step 1: merge raw tournament CSVs
│   ├── master_dataset_creation.py
│   │                              # Step 2: join aggregated files
│   └── clean_master_file.py      # Step 3: clean data and add target
│
├── notebooks/
...
Open and run the notebook directly in your browser - no local setup required, completely seamless:

[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1lmJre9uRpAufxrmxrpWZB8TNrXFlw5VO?usp=sharing)
